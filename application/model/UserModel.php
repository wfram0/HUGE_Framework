...
class UserModel
{
    ...
    public static function getPublicProfilesOfAllUsers()
    {
        ...
        $sql = "SELECT users.user_id, users.user_name, users.user_email, users.user_active, users.user_has_avatar, users.user_deleted, groups.group_name 
                FROM users
                LEFT JOIN groups
                ON users.user_account_type = groups.group_id";
